...
class _$AppState extends AppState {
  ...
  _$AppState._({this.isLoading, this.userState}) : super._() {
    if (isLoading == null) {
  ...
  @override
  int get hashCode {
    return $jf($jc($jc(0, isLoading.hashCode), userState.hashCode));
  }
...
class AppStateBuilder implements Builder<AppState, AppStateBuilder> {
  ...
  _$AppState build() {
    ...
    try {
      _$result = _$v ??
          new _$AppState._(isLoading: isLoading, userState: userState.build());
    } catch (_) {
